...
buyer_account_settings = Blueprint('buyer_account_settings', __name__)

@buyer_account_settings.route('/buyer/account-settings', methods=['GET'])
...
@buyer_account_settings.route('/buyer/account-settings/update', methods=['POST'])
